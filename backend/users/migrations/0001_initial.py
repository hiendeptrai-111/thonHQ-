    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Ban chấp hành / Cán bộ Đoàn'), ('USER', 'Đoàn viên / Thanh niên')], default='USER', max_length=10)),
                ('department', models.CharField(blank=True, max_length=100, null=True, verbose_name='Khoa')),
                ('branch', models.CharField(blank=True, max_length=100, null=True, verbose_name='Chi đoàn')),
